...
def get_zero_shot_template_tacred_rag(sentence, relation, head, tail, context):
    ...
    template_zero_shot = """Problem Definition: Relation extraction is to identify the relationship between two entities in a sentence.\n""" + \
                         ...
                         """ Context: """ + str(context[0]["similar_sentence"]) + """ Given the context, the relation between """ + str(context[0]["similar_train_head"]) + """ and """ + str(context[0]["similar_train_tail"]) + """ is """ + str(context[0]["similar_train_relation"]) + """.\t""" + \
                         """ Query Sentence: """ + str(sentence) + """\n""" + \
                         """ head: """ + head + """ \n""" + \
                         """ tail: """ + tail + """ \n""" + \
                         """ Given relation types: """ + relation["sel_relations"] + """\n""" + \
                         """relation explanations: """ + relation["sel_explanations_formatted"] +  """\n""" \
                         """ Output format: relation_type"""
